<p align="center">
  <a href="https://paicoding.com/">
    <img src="https://cdn.tobebetterjavaer.com/images/README/1681354262213.png" alt="CodeHive，让技术也能很好玩" width="400">
  </a>
</p>
...
<br><br>
<p align="center">
  <a href="https://paicoding.com/article/detail/15"><img src="https://img.shields.io/badge/CodeHive-学习圈子-brightgreen.svg?style=for-the-badge"></a>
  <a href="https://paicoding.com/" target="_blank"><img src="https://img.shields.io/badge/CodeHive-首页-critical?style=for-the-badge"></a>
  <a href="https://github.com/itwanger/paicoding-admin" target="_blank"><img src="https://img.shields.io/badge/CodeHive-管理端-yellow.svg?style=for-the-badge"></a>
  <a href="https://gitee.com/itwanger/paicoding" target="_blank"><img src="https://img.shields.io/badge/CodeHive-码云地址-blue.svg?style=for-the-badge"></a>
</p>


## 一、配套服务
 
1. **CodeHive网址**：[https://paicoding.com](https://paicoding.com)
2. **CodeHive教程**：[https://paicoding.com/column](https://paicoding.com/column) 目前已更新高并发手册、JVM 手册、Java 并发编程手册、二哥的 Java 进阶之路，以及CodeHive部分免费教程。我们的宗旨是：**学编程，就上CodeHive**😁
3. **CodeHive管理端源码**：[paicoding-admin](https://github.com/itwanger/paicoding-admin)
4. **CodeHive专属学习圈子**：[不走弯路，少采坑，附 120 篇CodeHive全套教程](https://paicoding.com/article/detail/17) 
5. **派聪明AI助手**：AI 时代，怎能掉队，欢迎体验 [CodeHive的派聪明 AI 助手](https://paicoding.com/chat)
...
![CodeHive首页](https://cdn.tobebetterjavaer.com/images/20230602/d7d341c557e7470d9fb41245e5bb4209.png)

#### Vue 版前后端分离版本

这个版本对CodeHive进行了二次开发，将用户端的前端 UI 使用 Vue3 重写，并且将后端升级到 Spring Boot 3 版本，喜欢 Vue3 或者 Spring Boot 3 版本的球友可以看看这个分支。
...
![CodeHive后台管理系统](https://cdn.tobebetterjavaer.com/images/20230602/83139e13a4784c0fbf0adedd8e287c5b.png)

admin 端部署写在了 paicoding-admin 项目的 README.md 中，请注意查看⚠️。

#### 代码展示

![CodeHive源码结构](https://cdn.tobebetterjavaer.com/images/20231205/b8f76cb8e09f4ebca84b3ddd3b61c13e.png)
...
![CodeHive系统架构图](https://cdn.tobebetterjavaer.com/paicoding/3da165adfcad0f03d40e13e941ed4afb.png)


#### 业务架构图

![CodeHive业务架构图](https://cdn.tobebetterjavaer.com/paicoding/main/paicoding-business.jpg)
...
CodeHive教程共 120+ 篇，从中整理出 20 篇，供大家免费学习。
- [（🌟 新人必看）CodeHive系统架构&功能模块一览](https://paicoding.com/article/detail/15)
- [（🌟 新人必看）小白如何学习CodeHive](https://paicoding.com/article/detail/366)
- [（🌟 新人必看）如何将CodeHive写入简历](https://paicoding.com/article/detail/373)
- [（🌟 新人必看）CodeHive架构方案设计](https://paicoding.com/column/6/5)
- [（🌟 新人必看）CodeHive技术方案设计](https://paicoding.com/article/detail/208)
- [（🌟 新人必看）CodeHive项目管理流程](https://paicoding.com/article/detail/445)
- [（🌟 新人必看）CodeHiveMVC分层架构](https://paicoding.com/article/detail/446)
- [（🌟 新人必看）CodeHive项目工程搭建手册](https://paicoding.com/article/detail/459)
- [（👍 强烈推荐）CodeHive微信公众号自动登录](https://paicoding.com/article/detail/448)
- [（👍 强烈推荐）CodeHive微信扫码登录实现](https://paicoding.com/article/detail/453)
- [（👍 强烈推荐）CodeHiveSession/Cookie身份验证识别](https://paicoding.com/article/detail/449)
- [（👍 强烈推荐）CodeHiveMysql/Redis缓存一致性](https://paicoding.com/column/6/3)
- [（👍 强烈推荐）CodeHiveRedis实现用户活跃排行榜](https://paicoding.com/article/detail/454)
- [（👍 强烈推荐）CodeHive消息队列RabbitMQ](https://paicoding.com/column/6/2)
- [（👍 强烈推荐）CodeHive消息队列RabbitMQ连接池](https://paicoding.com/column/6/1)
- [（👍 强烈推荐）CodeHive消息队列Kafka](https://paicoding.com/article/detail/460)
- [（👍 强烈推荐）CodeHiveCancal实现MySQL和ES同步](https://paicoding.com/column/6/8)
- [（👍 强烈推荐）CodeHiveES实现查询](https://paicoding.com/article/detail/341)
- [（👍 强烈推荐）CodeHive定时任务实现](https://paicoding.com/article/detail/457)
...
- [paicoding-admin](https://github.com/itwanger/paicoding-admin) ：🚀🚀🚀 paicoding-admin，CodeHive管理端，基于 React18、React-Router v6、React-Hooks、Redux、TypeScript、Vite3、Ant-Design 5.x、Hook Admin、ECharts 的一套社区管理系统，够惊艳哦。

## 六、鸣谢

CodeHive收到了 [Jetbrains](https://jb.gg/OpenSourceSupport) 多份 Licenses（详情戳 [这里](https://paicoding.com/article/detail/331) ），并已分配给项目 [活跃开发者](https://github.com/itwanger/paicoding/graphs/contributors) ，非常感谢 Jetbrains 对开源社区的支持。
...
Copyright (c) 2022-2025 CodeHive（楼仔、沉默王二、一灰、小超、小灰飞）
