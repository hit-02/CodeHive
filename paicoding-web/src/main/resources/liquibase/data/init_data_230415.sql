...
INSERT INTO article
(id, user_id, article_type, title, short_title, picture, summary, category_id, source, source_url, offical_stat, topping_stat, cream_stat, status, deleted)
VALUES(15, 1, 1, '官宣：CodeHive上线了！⭐️一款好用又强大的开源社区，学编程，就上CodeHive?', '', 'https://cdn.tobebetterjavaer.com/paicoding/e95f60537f490bb96560aae25e2d53f0.jpg', '一个基于 Spring Boot、MyBatis-Plus、MySQL、Redis、ElasticSearch、MongoDB、Docker、RabbitMQ 等技术栈实现的社区系统，采用主流的互联网技术架构、全新的UI设计、支持一键源码部署，拥有完整的文章&教程发布/搜索/评论/统计流程等，代码完全开源，没有任何二次封装，是一个非常适合二次开发/实战的现代化社区项目? ', 1, 2, '', 1, 0, 0, 1, 0);
INSERT INTO article
(id, user_id, article_type, title, short_title, picture, summary, category_id, source, source_url, offical_stat, topping_stat, cream_stat, status, deleted)
VALUES(16, 1, 1, '对标大厂的CodeHive详细方案设计，务必要看', '', 'https://cdn.tobebetterjavaer.com/paicoding/7f492cb729d944097d6676b7f19d3ff9.png', '这个项目诞生的背景和企业内生的需求不太一样，主要是某一天二哥说，“我们一起搞事吧”，楼仔问，“搞什么”，然后这个项目的需求就来了言归正传，我们主要的目的是希望打造一个切实可用的项目，依托于这个项目，将java从业者所用到的技术栈真实的展现出来，对于经验不是那么足的小伙伴，可以在一个真实的系统上，理解到自己学习的知识点是如何落地的，同时也能真实的了解一个项目是从0到1实现的全过程系统模块介绍系统架构基于社区系统的分层特点，将整个系统架构划分为展示层，应用层，服务层，如下图展示层其中展示层主要为用', 1, 2, '', 1, 0, 0, 1, 0);
INSERT INTO article
(id, user_id, article_type, title, short_title, picture, summary, category_id, source, source_url, offical_stat, topping_stat, cream_stat, status, deleted)
VALUES(17, 1, 1, 'CodeHive的知识星球，开通啦！附 120 篇CodeHive的详细教程！', '', '', '大家好呀，我是楼仔。上周推出了我们的开源项目CodeHive，大家好评如潮，很多同学都想学习这个项目，为了更好带大家一起飞，我们今天正式推出CodeHive的知识星球。什么是知识星球呢？你可以理解为高品质社群，方便大家跟着我们一起学习。01星球介绍先来介绍下星球的三位联合创始人：楼仔：8年一线大厂后端经验（百度/小米/美团），CodeHive团队负责人，擅长高并发、架构、源码，有很强的项目/团队管理、职业规划能力。沉默王二：GitHub星标6400k开源知识库《Java程序员进阶之路》作者，CSDN两届博客之星，掘金/知乎Java领域优', 1, 2, '', 1, 0, 0, 1, 0);
...
你也可以到CodeHive的[教程栏（戳这里）](https://paicoding.com/column)里阅读，目前正在连载更新中。

![](https://cdn.tobebetterjavaer.com/stutymore/readme-20230410215012.png)

>CodeHive是一个基于 Spring Boot、MyBatis-Plus、MySQL、Redis、ElasticSearch、MongoDB、Docker、RabbitMQ 等技术栈实现的社区系统，采用主流的互联网技术架构、全新的UI设计、支持一键源码部署，拥有完整的文章&教程发布/搜索/评论/统计流程等，[代码完全开源（可戳）](https://github.com/itwanger/paicoding)，没有任何二次封装，是一个非常适合二次开发/实战的现代化社区项目? 。
...
除了《Java 面试指南》外，星球还提供了《编程喵实战项目笔记》、《二哥的 LeetCode 刷题笔记》，以及CodeHive实战项目配套的 120+篇硬核教程。

![](https://cdn.tobebetterjavaer.com/stutymore/readme-20230411113022.png)

这里重点介绍一下CodeHive吧，这个项目上线后，一直广受好评，读者朋友们的认可度非常高，项目配套的教程也足够的硬核。
...
- CodeHive系统架构、功能模块一览（⭐️⭐️⭐️⭐️⭐️）

大厂篇：

- CodeHive产品调研，让你了解产品诞生背后的故事（⭐️⭐️）
- CodeHive产品设计（⭐️）
- CodeHive交互视觉设计（⭐️）
- CodeHive整体架构方案设计全过程（⭐️⭐️⭐️）
- 技术方案详细设计（⭐️⭐️⭐️⭐️）
- CodeHive项目管理流程（⭐️⭐️）
- CodeHive项目管理研发阶段（⭐️⭐️⭐️）

基础篇：

- CodeHive中实体对象 DO、DTO、VO 到底代表了什么（⭐️）
- 通过CodeHive项目讲解 MVC 分层架构的应用（⭐️⭐️）
- CodeHive整合本地缓存之Guava（⭐️⭐️⭐️）
- CodeHive整合本地缓存之Caffeine（⭐️⭐️⭐️⭐️）
- CodeHive整合 Redis（⭐️）
- CodeHive中基于 Redis 的缓存示例（⭐️⭐️⭐️）
- CodeHive中基于Cacheable注解实现缓存示例（⭐️⭐️）
- CodeHive中的事务使用实例（⭐️⭐️⭐️）
- 事务使用的 7 条注意事项（⭐️⭐️⭐️）
- CodeHive中的多配置文件说明（⭐️）
- CodeHive整合 Logback/lombok 配置日志输出（⭐️）
- CodeHive整合邮件服务实现邮件发送（⭐️）
- Web 三大组件之 Filter 在CodeHive中的应用（⭐️）
- Web 三大组件之 Servlet 在CodeHive中的应用（⭐️）
- Web 三大组件之 listenter 在CodeHive中的应用（⭐️）
- CodeHive实时在线人数统计-单机版（⭐️）

进阶篇：

- CodeHive之扫码登录实现原理（⭐️）
- CodeHive身份验证之session与 cookie（⭐️）
- CodeHive中基于异常日志的报警通知（⭐️）

扩展篇：

- CodeHive的数据库表自动初始化实现方案（⭐️⭐️⭐️⭐️⭐️）
- CodeHive中基于 filter 实现请求日志记录（⭐️）

工程篇：

- CodeHive项目工程搭建手册（⭐️⭐️⭐️⭐️）
- CodeHive本地多机器部署开发教程（⭐️⭐️）
- CodeHive服务器部署指导手册（⭐️⭐️）
- CodeHive的 MVC 分层架构（⭐️⭐️）
- CodeHive Docker 本机部署开发手册（⭐️⭐️⭐️）
- CodeHive多环境配置管理（⭐️）

欣赏一下CodeHive实战项目的首页吧，绝壁清新、高级、上档次！
...
但是需要注意的是，后台也是同样有文章、评论、用户等业务功能的，前台与后台可使用应用主要是权限粒度管理的差异性，对于CodeHive系统而言，我们的应用可分为：
...
- 硬件资源：容器，ecs服务器
### 术语介绍
CodeHive整个系统中涉及到的术语并不多，也很容易理解，下面针对几个常用的进行说明
...
## 系统模块设计
针对前面CodeHive的业务架构拆分，CodeHive的实际项目划分，主要是五个模块，相反并没由将上面的每个应用、服务抽离为独立的模块，主要是为了避免过渡设计，粒度划分太细会增加整个项目的理解维护成本

这里设置五个相对独立的模块，则主要是基于边界特别清晰这一思考点进行，后续做微服务演进时，下面每个模块可以作为独立的微服务存在

### 用户模块
在CodeHive中，整个用户模块从功能角度可以分为
...
##### 用户轨迹
在CodeHive的整体设计中，我们希望记录用户的阅读历史、关注列表、收藏列表、评价的文章列表，对于这种用户行为轨迹的诉求，我们采用设计一张大宽表的策略，其主要目的在于
...
#### 点赞收藏
再CodeHive中，对于文章提供了点赞、收藏、评论三种交互，这里重点看一下点赞与收藏；
...
#### 评论点赞
CodeHive中同样支持对评论进行点赞，取消点赞；对于点赞的整体业务逻辑操作，实际上与文章的点赞一致，因此我们直接复用了文章的点赞逻辑，借助 `user_foot` 来实现的

**说明**

- 上面这种实现并不是一种优雅的选择，从`user_foot`的设计也能看出，它实际上与评论点赞这个业务是有些隔离的
- 采用上面这个方案的主要原因在于，点赞这种属于通用的服务，使用mysql来维系点赞与否以及计数统计，再数据量大了之后，基本上玩不转；后续会介绍如何设计一个通用的点赞服务，以此来替换CodeHive中当前的点赞实现
...
### 通用模块
关于CodeHive中的通用模块大致有下面几种，相关的技术方案也比较简单，将配合库表进行简单说明
...
#### 搜索推荐
CodeHive当前的搜索推荐主要是基于数据库来实现，后续再介绍es相关教程时，会同步引入ES进行替换当前的数据库方案
...
当然了，这些教程会优先开放给[CodeHive编程星球](https://t.zsxq.com/0buCVQ3qQ)的球友们，毕竟这群家伙都是氪金过的 VIP，一直在等这个项目的官宣，等的嗷嗷叫。

![](https://cdn.tobebetterjavaer.com/paicoding/207544feafb505be2dacdf22510de9f6.png)

如果你也想加入CodeHive的编程星球，现在送出 30 元的优惠券，原价 129 元，等于说优惠完**只需要 99 年就可以加入，每天不到 0.27 元**，超级划算！
...
1. **CodeHive项目学习教程**，后续会采用连载的方式，让你从 0 到 1 也能搭建一套自己的网站
2. CodeHive项目答疑解惑，让你快速上手该项目，小白也能懂
...
最后，希望球友们，能紧跟我们的步伐！不要掉队。兔年，和我们CodeHive一起翻身、一起逆袭、一起晋升、一起拿高薪 offer！
...
上周推出了我们的开源项目「CodeHive」，大家好评如潮，很多同学都想学习这个项目，为了更好带大家一起飞，我们今天正式推出CodeHive的知识星球。
...
*   **楼仔**：8 年一线大厂后端经验（百度/小米/美团），CodeHive团队负责人，擅长高并发、架构、源码，有很强的项目/团队管理、职业规划能力。
...
对于CodeHive项目中遇到的问题，**大家可以加入CodeHive的知识星球群，我们会给大家一一解答**，即使你是小白，也完全不用担心。
...
CodeHive的知识星球原价是 **129** 元，特地给大家申请了一波 30 元的优惠券，最后的优惠价是 **99** 元。

![](https://cdn.tobebetterjavaer.com/paicoding/c485a03da98e567cfcd18aacd329c9ce.png)

可能有同学会说，你的星球有点贵，这个还真不一样，**你需要看服务内容，并不是所有的星球，都有CodeHive这样的项目，都有我们这样专业的团队。**
...
**可以这么说，对于CodeHive提供的服务，只要有一项你需要，基本能赚回票价，绝对不会让粉丝们吃亏。**
...
给大家官宣一件大事，我们搞了近半年的实战项目——[**CodeHive**](https://paicoding.com/)，终于上线了！瞅瞅这首页，清新、高级、上档次！
...
好了，接下来，就由我来给大家“隆重”地介绍一下CodeHive的整个生态圈子。
...
我们希望通过**CodeHive**这个项目打造一个闭环，既能帮大家提升项目经验、升职加薪，又能提升我们的技术影响力，还能增加我们原创教程的流量（典型的既要又要还要，有没有?）。
...
这个项目并不是二哥一时兴起发起的，而是做了充分的准备和调研。来介绍一下我们CodeHive的联合创始人，前后端我们三个人均有参与：
...
INSERT INTO config
(id, `type`, name, banner_url, jump_url, content, `rank`, status, tags, extra, deleted, create_time, update_time)
VALUES(3, 4, '官宣：CodeHive上线了！', '11', 'https://paicoding.com/article/detail/169', '学编程，就上CodeHive?！', 1, 1, '2', '{}', 0, '2023-01-13 19:15:57', '2023-04-15 14:55:38');
INSERT INTO config
(id, `type`, name, banner_url, jump_url, content, `rank`, status, tags, extra, deleted, create_time, update_time)
VALUES(4, 4, 'Java进阶之路.pdf来了！', ' 2', 'https://paicoding.com/column/5/1', '学 Java，就认准二哥的 Java 进阶之路。第一版 PDF 开放下载了！CodeHive团队出品。', 2, 1, '2', '{}', 0, '2023-01-13 19:15:57', '2023-04-15 16:04:49');
INSERT INTO config
(id, `type`, name, banner_url, jump_url, content, `rank`, status, tags, extra, deleted, create_time, update_time)
VALUES(5, 6, 'JVM 核心手册', ' https://img14.360buyimg.com/ddimg/jfs/t1/184999/39/32111/443189/63c7fbbbF78e720ff/7e878308d3d27dff.png', 'https://paicoding.com/article/detail/151', '楼仔原创的 JVM 手册，带你成为 Java 高手！CodeHive团队出品。', 2, 1, '1', '{"visit":110252,"download":12121,"rate":"9.1"}', 0, '2023-01-13 19:15:58', '2023-04-15 21:23:09');
INSERT INTO config
(id, `type`, name, banner_url, jump_url, content, `rank`, status, tags, extra, deleted, create_time, update_time)
VALUES(6, 6, 'Spring源码解析手册', 'https://img13.360buyimg.com/ddimg/jfs/t1/114223/5/31528/3308443/63c7f65eFdb3a20f2/91c8c191152d82c2.png', 'https://paicoding.com/article/detail/150', '楼仔原创的 Spring 源码解读手册，硬核，带你成为 Spring 高手！CodeHive团队出品。', 2, 1, '1', '{"visit":120248,"download":212103,"rate":"9.3"}', 0, '2023-01-13 19:15:58', '2023-04-15 21:23:09');


update article set summary = 'CodeHive（paicoding）是一个前后端分离的 Java 社区实战项目，基于 SpringBoot+MyBatis-Plus 实现，采用 Docker 容器化部署。包括前台社区系统和后台管理系统。前台社区系统包括社区首页、文章推荐、文章搜索、文章发布、文章详情、优质教程、个人中心等模块；后台管理系统包括文章管理、教程管理、统计报表、权限菜单管理、设置等模块。' where id = 1;
