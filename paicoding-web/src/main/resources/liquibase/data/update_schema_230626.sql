...
(
    ...
    `star_type`       tinyint     NOT NULL DEFAULT '0' COMMENT '星球来源 1=java进阶之路 2=CodeHive',
    ...
    `strategy`        int         NOT NULL DEFAULT '0' COMMENT '二进制表示法：0位绑定微信公众号 1位 绑定邀请 2位绑定java进阶星球 3位绑定CodeHive星球',
...
(
    `id`          int unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `user_id`     int          NOT NULL DEFAULT '0' COMMENT '用户id',
    `ai_type`     tinyint      NOT NULL DEFAULT '0' COMMENT '使用的AI类型 0=CodeHive 1=chatgpt3.5  2=chatgpt4 3=讯飞',
